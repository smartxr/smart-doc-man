            ...
            "dataSources": [
                {
                    ...
                    "parameters": {
                        ...
                        "key": os.environ.get(f'SEARCH_API_KEY_{search_resource.replace("-", "_").upper()}'),
...
def run_chat_complition(client: AzureOpenAI, chat_history: list, extra_body_value: dict):
